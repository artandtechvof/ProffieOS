...
#ifdef CONFIG_TOP
#include "aat_teensy_hardware_v4_config.h"
#define NUM_BLADES 4
...
BladeConfig blades[] = {
 { 0, DimBlade(40,WS281XBladePtr<49, bladePin, Color8::BRG, PowerPINS<> >()),
      DimBlade(40,WS281XBladePtr<48, blade2Pin, Color8::BRG, PowerPINS<> >()),
      DimBlade(40,WS281XBladePtr<47, blade3Pin, Color8::BRG, PowerPINS<> >()),
